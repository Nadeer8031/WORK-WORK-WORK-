...
function setProfilePic(gender) {
  const male = document.getElementById("malePic");
  const female = document.getElementById("femalePic");

  male.classList.toggle("hidden", gender !== "male");
  female.classList.toggle("hidden", gender !== "female");
}
(function () {
